...
public abstract class AbstractCommand {
    ...
    protected abstract ReturnType runCommand(PerfectFlight instance, CommandSender sender, String... args) throws MissingPermissionException;

    protected abstract List<String> onTab(PerfectFlight instance, CommandSender sender, String... args);
